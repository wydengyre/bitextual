...
const importMeta = {
    url: "file:///Users/mleon/proj/hunalign/build/hunalign.js",
    main: false
};
var mkHunalign = (()=>{
    ...
    return async function(mkHunalign) {
        ...
        if (ENVIRONMENT_IS_NODE) {
            ...
            var require = createRequire(importMeta.url);
            var fs = require("fs");
            var nodePath = require("path");
            if (ENVIRONMENT_IS_WORKER) {
                scriptDirectory = nodePath.dirname(scriptDirectory) + "/";
            } else {
                scriptDirectory = require("url").fileURLToPath(new URL("./", importMeta.url));
            }
        ...
        var wasmBinaryFile;
        if (Module["locateFile"]) {
            wasmBinaryFile = "hunalign.wasm";
            if (!isDataURI(wasmBinaryFile)) {
                wasmBinaryFile = locateFile(wasmBinaryFile);
            }
        } else {
            wasmBinaryFile = new URL("hunalign.wasm", importMeta.url).href;
        }
        ...
        run();
        return mkHunalign.ready;
    };
})();
class Hunalign {
    #module;
    #printLog;
    constructor(module, printLog){
        this.#module = module;
        this.#printLog = printLog;
    }
    run(dictionary, source, target) {
